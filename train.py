...
if __name__ == '__main__':
    ...
    for parser_ in (base_parser, parser):
        ...
        parser_.add_argument("--ckpt", type=str, default=None, help="Checkpoint to resume training")
        parser_.add_argument("--n_gpus", type=int, default=4, help="Number of gpus to use for training")
    ...
    trainer = pl.Trainer.from_argparse_args(
        ...
        devices = args.n_gpus, 
        logger=logger,
        log_every_n_steps=10, num_sanity_val_steps=2, 
        callbacks=callbacks,
        max_epochs=200,
